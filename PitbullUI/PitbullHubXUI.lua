...
local PitbullHubX = {}
function PitbullHubX:Notify(NotifyConfig)
...
function PitbullHubX:Start(GuiConfig)
    ...
    local Flags = PitbullHubX and PitbullHubX.Flags or {}
    ...
    function PitbullHubX:ToggleUI()
        Main.Visible = not Main.Visible
    end

    function PitbullHubX:CloseUI()
        SpeedGui:Destroy()
    ...
    MinimizeButton.Image = "rbxassetid://100936948879529"
    ...
    MinimizeButton.MouseButton1Click:Connect(PitbullHubX.ToggleUI)
